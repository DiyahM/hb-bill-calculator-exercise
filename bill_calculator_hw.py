...
def calculate_bill():
    ...
    original_bill = (salads * 4) + (burgers * 5) + (drinks * 2)
    global tip
...
def prompt_user():
    global salads, burgers, drinks
    salads = int(raw_input('How many salads did you have?'))
    burgers = int(raw_input('How many burgers did you have?'))
    drinks = int(raw_input('How many drinks did you have?'))
